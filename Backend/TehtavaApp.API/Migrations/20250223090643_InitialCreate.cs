        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolGroups_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseSchoolGroup", x => new { x.CoursesId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_CourseSchoolGroup_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSchoolGroup_SchoolGroups_GroupsId",
                        column: x => x.GroupsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Notifications_SchoolGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "SchoolGroups",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentGroupEnrollments_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentGroupEnrollments_SchoolGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "SchoolGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmittedMaterialsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentSubmissionMaterial", x => new { x.SubmissionsId, x.SubmittedMaterialsId });
                    table.ForeignKey(
                        name: "FK_AssignmentSubmissionMaterial_AssignmentSubmissions_SubmissionsId",
                        column: x => x.SubmissionsId,
                        principalTable: "AssignmentSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentSubmissionMaterial_Materials_SubmittedMaterialsId",
                        column: x => x.SubmittedMaterialsId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSubmissionMaterial_SubmittedMaterialsId",
                table: "AssignmentSubmissionMaterial",
                column: "SubmittedMaterialsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSchoolGroup_GroupsId",
                table: "CourseSchoolGroup",
                column: "GroupsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolGroups_CreatedById",
                table: "SchoolGroups",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGroupEnrollments_GroupId",
